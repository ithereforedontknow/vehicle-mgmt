...
<body class="bg-light">
    ...
    <div class="content" id="content">
        <div class="container">
            ...
            <button class="btn btn-primary float-end mb-2 ms-2" data-bs-toggle="modal" data-bs-target="#add-origin-modal">
            ...
            <table class="table table-hover text-center table-light" id="hauler-table">
                ...
                <tbody>
                    ...
                    ?>
                        <tr onclick="editOrigin(<?= $row['origin_id'] ?>)" style="cursor: pointer;">
                            <td class="text-center" scope="row"><?= $row['origin_name'] ?></td>
    ...
    <?php
    include_once('includes/add/add-origin-modal.php');
    include_once('includes/edit/edit-origin-modal.php');
    ?>
