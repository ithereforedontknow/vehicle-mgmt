  ...
  <main class="d-flex flex-nowrap" style="height: 100svh">
    ...
    <div class="container-fluid p-0 border-start">
      ...
      <div class="container w-75">
        ...
        <div class="container">
          <button class="btn btn-primary float-end mb-2" data-bs-toggle="modal" data-bs-target="#add-user-modal"><svg width="20px" height="20px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            </svg>Add User</button><label for="column-search">Search Name:</label>
          <input type="text" id="column-search" placeholder="John Doe">
