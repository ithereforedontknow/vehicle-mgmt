...
<body class="bg-light">
    ...
    <div class="content" id="content">
        <div class="container">
            ...
            <button class="btn btn-primary float-end mb-2 ms-2" data-bs-toggle="modal" data-bs-target="#add-hauler-modal">
            ...
            <table class="table table-hover text-center table-light" id="hauler-table">
                ...
                <tbody>
                    ...
                    ?>
                        <tr onclick="editHauler(<?= $row['hauler_id'] ?>)" style="cursor: pointer;">
                            <td class="text-center" scope="row"><?= $row['hauler_name'] ?></td>
                            <td class="text-center" scope="row"><?= $row['hauler_address'] ?></td>
    ...
    include_once('includes/edit/edit-hauler-modal.php');
    ?>
